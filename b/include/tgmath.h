...
#undef cimag
#if LDBL_MANT_DIG == DBL_MANT_DIG
#define creal(z) _Generic((z), float _Complex: crealf(z), default: (__real__(double _Complex)(z)))
#define cimag(z) _Generic((z), float _Complex: cimagf(z), default: (__imag__(double _Complex)(z)))
#else
#define creal(z) _Generic((z), float _Complex: crealf(z), long double _Complex: creall(z), default: (__real__(double _Complex)(z)))
#define cimag(z) _Generic((z), float _Complex: cimagf(z), long double _Complex: cimagl(z), default: (__imag__(double _Complex)(z)))
#endif
