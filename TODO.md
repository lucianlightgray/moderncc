...
STEP 1 [in progress: 1a ast_reemit_with_gates DONE (42fded0e); override table + mcc_jit_submit_ast + recompile integration DONE, default-off; REMAINING: pool-triggered swap on submit + jit/selftest-submit-ast] — backend override API + per-sym override table + threaded submit (on the
