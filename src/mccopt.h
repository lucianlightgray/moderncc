...
#define MCC_OPT_LIST(MCC_OPT_ROW) \
	...
	MCC_OPT_ROW(TREE_CONST_LOAD,               "tree-const-load",              MCC_OPTD_LEVEL(11)) \
	...
	MCC_OPT_ROW(OPT_SEARCH_THREADS,            "opt-search-threads",           MCC_OPTD_OFF) \
	MCC_OPT_ROW(OPT_SEARCH_PTHREADS,           "opt-search-pthreads",          MCC_OPTD_OFF) \
	...
	MCC_OPT_ROW(OPT_CYCLE,                     "opt-cycle",                    MCC_OPTD_LEVEL(11)) \
	...
	MCC_OPT_ROW(CHAIN_STORE,                   "chain-store",                  MCC_OPTD_LEVEL(11)) \
	...
	MCC_OPT_ROW(CHAIN_STORE_LIVE,              "chain-store-live",             MCC_OPTD_LEVEL(10)) \
	MCC_OPT_ROW(CHAIN_STORE_MEMBER,            "chain-store-member",           MCC_OPTD_LEVEL(11)) \
	...
	MCC_OPT_ROW(PROMOTE_LEAF_CALLEE,           "promote-leaf-callee",          MCC_OPTD_LEVEL(10)) \
	...
	MCC_OPT_ROW(SETHI_ULLMAN,                  "sethi-ullman",                 MCC_OPTD_LEVEL(10)) \
	MCC_OPT_ROW(SETHI_ULLMAN_LEAF,             "sethi-ullman-leaf",            MCC_OPTD_LEVEL(10)) \
	MCC_OPT_ROW(SETHI_ULLMAN_NARY,             "sethi-ullman-nary",            MCC_OPTD_LEVEL(11)) \
	MCC_OPT_ROW(TREE_SWITCH_CONVERSION,        "tree-switch-conversion",       MCC_OPTD_LEVEL(11)) \
	MCC_OPT_ROW(DUMP_BITFLAG,                  "dump-bitflag",                 MCC_OPTD_OFF) \
	MCC_OPT_ROW(TREE_COPY_PROP,                "tree-copy-prop",               MCC_OPTD_LEVEL(11)) \
	...
	MCC_OPT_ROW(NARROW_ELIM,                   "narrow-elim",                  MCC_OPTD_LEVEL(12)) \
	MCC_OPT_ROW(TREE_CCP_ITERATE,              "tree-ccp-iterate",             MCC_OPTD_LEVEL(11)) \
	...
	MCC_OPT_ROW(TREE_DSE,                      "tree-dse",                     MCC_OPTD_LEVEL(12)) \
	MCC_OPT_ROW(OPTIMIZE_SIBLING_CALLS,        "optimize-sibling-calls",       MCC_OPTD_LEVEL(12)) \
	MCC_OPT_ROW(GCSE,                          "gcse",                         MCC_OPTD_LEVEL(12)) \
	MCC_OPT_ROW(TREE_VRP,                      "tree-vrp",                     MCC_OPTD_LEVEL(10)) \
	MCC_OPT_ROW(DIVMAGIC,                      "divmagic",                     MCC_OPTD_LEVEL(2)) \
	MCC_OPT_ROW(IF_CONVERSION_ABS,             "if-conversion-abs",            MCC_OPTD_LEVEL(2)) \
	MCC_OPT_ROW(IF_CONVERSION,                 "if-conversion",                MCC_OPTD_LEVEL(10)) \
	MCC_OPT_ROW(TREE_REASSOC,                  "tree-reassoc",                 MCC_OPTD_LEVEL(10)) \
	...
	MCC_OPT_ROW(LOOP_INTERCHANGE,              "loop-interchange",             MCC_OPTD_LEVEL(12)) \
	MCC_OPT_ROW(LOOP_FUSION,                   "loop-fusion",                  MCC_OPTD_LEVEL(12)) \
	MCC_OPT_ROW(LOOP_BLOCK,                    "loop-block",                   MCC_OPTD_LEVEL(12)) \
	MCC_OPT_ROW(LOOP_VLAT,                     "loop-vlat",                    MCC_OPTD_LEVEL(11)) \
	MCC_OPT_ROW(JIT_SPLICE,                    "jit-splice",                   MCC_OPTD_OFF) \
	MCC_OPT_ROW(ZERO_INITIALIZED_IN_BSS,       "zero-initialized-in-bss",      MCC_OPTD_LEVEL(12)) \
	MCC_OPT_ROW(MERGE_CONSTANTS,               "merge-constants",              MCC_OPTD_LEVEL(2)) \
	MCC_OPT_ROW(GCSE_JOIN,                     "gcse-join",                    MCC_OPTD_LEVEL(11)) \
	MCC_OPT_ROW(CALL_WINDOW,                   "call-window",                  MCC_OPTD_LEVEL(12)) \
	MCC_OPT_ROW(TREE_LOOP_IM,                  "tree-loop-im",                 MCC_OPTD_LEVEL(11)) \
	...
	MCC_OPT_ROW(SPILL_SHARE,                   "spill-share",                  MCC_OPTD_LEVEL(12))
