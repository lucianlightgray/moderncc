...
#define MCC_OPT_LIST(MCC_OPT_ROW) \
	...
	MCC_OPT_ROW(OPT_CYCLE,                     "opt-cycle",                    MCC_OPTD_LEVEL(3)) \
	...
	MCC_OPT_ROW(SETHI_ULLMAN,                  "sethi-ullman",                 MCC_OPTD_LEVEL(1)) \
	MCC_OPT_ROW(SETHI_ULLMAN_LEAF,             "sethi-ullman-leaf",            MCC_OPTD_LEVEL(1)) \
	MCC_OPT_ROW(SETHI_ULLMAN_NARY,             "sethi-ullman-nary",            MCC_OPTD_LEVEL(1)) \
	...
	MCC_OPT_ROW(NARROW_ELIM,                   "narrow-elim",                  MCC_OPTD_LEVEL(1)) \
	MCC_OPT_ROW(TREE_CCP_ITERATE,              "tree-ccp-iterate",             MCC_OPTD_LEVEL(2)) \
	...
	MCC_OPT_ROW(LOOP_INTERCHANGE,              "loop-interchange",             MCC_OPTD_LEVEL(2)) \
	MCC_OPT_ROW(LOOP_FUSION,                   "loop-fusion",                  MCC_OPTD_LEVEL(2)) \
	MCC_OPT_ROW(LOOP_BLOCK,                    "loop-block",                   MCC_OPTD_LEVEL(2)) \
	MCC_OPT_ROW(LOOP_VLAT,                     "loop-vlat",                    MCC_OPTD_LEVEL(2)) \
	MCC_OPT_ROW(JIT_SPLICE,                    "jit-splice",                   MCC_OPTD_OFF) \
	MCC_OPT_ROW(ZERO_INITIALIZED_IN_BSS,       "zero-initialized-in-bss",      MCC_OPTD_LEVEL(2)) \
	MCC_OPT_ROW(MERGE_CONSTANTS,               "merge-constants",              MCC_OPTD_LEVEL(2)) \
	MCC_OPT_ROW(GCSE_JOIN,                     "gcse-join",                    MCC_OPTD_LEVEL(2)) \
