...
#define ARM64_MOVZ64      0xD2800000U
#define ARM64_MOVN64      0x92800000U
...
#define ARM64_STR_X_PRE   0xF8000000U
#define ARM64_LDR_X_POST  0xF8400000U

#define ARM64_LDR_SCALAR  0x3D400000U
#define ARM64_LDR_S_VEC   0xBD400000U
#define ARM64_LDR_D_VEC   0xFD400000U
#define ARM64_LDR_Q_VEC   0x3DC00000U
#define ARM64_STR_SCALAR  0x3D000000U
...
#define ARM64_LSR_IMM_32  0x53000000U
...
#define ARM64_FMOV_SCALAR 0x1E604000U
#define ARM64_FMOV_XD     0x9E660000U
#define ARM64_FMOV_WS     0x1E260000U

#define ARM64_MOV_V16B    0x4EA01C00U

#define ARM64_STR_Q_PRE   0x3C800000U
#define ARM64_LDR_Q_POST  0x3CC00000U
...
#define ARM64_EXTR64      0x93C00000U


#define ARM64_ORR_REG_LSL 0x2A000000U


#define ARM64_SUB_REG_LSL 0xCB000000U
