...
ALT(DEF_ASM_OP2(addb, 0x00, 0, OPC_ARITH | OPC_MODRM | OPC_BWLX, OPT_REG, OPT_EA | OPT_REG))
...
DEF_ASM_OP1(xsave64, 0x0fae, 4, OPC_MODRM | OPC_48, OPT_EA)
DEF_ASM_OP1(xrstor64, 0x0fae, 5, OPC_MODRM | OPC_48, OPT_EA)
DEF_ASM_OP1(xsaveopt64, 0x0fae, 6, OPC_MODRM | OPC_48, OPT_EA)
...
DEF_ASM_OP0L(swapgs, 0xf8, 0, OPC_0F01)
...
DEF_ASM_OP2(pmuludq, 0x0ff4, 0, OPC_MODRM, OPT_EA | OPT_MMXSSE, OPT_MMXSSE)
...
DEF_ASM_OP2(movaps, 0x0f28, 0, OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE)
...
ALT(DEF_ASM_OP2(movss, 0xf30f11, 0, OPC_MODRM, OPT_SSE, OPT_EA | OPT_REG32))
DEF_ASM_OP2(movsd, 0xf20f10, 0, OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE)
ALT(DEF_ASM_OP2(movsd, 0xf20f11, 0, OPC_MODRM, OPT_SSE, OPT_EA | OPT_REG32))
...
DEF_ASM_OP2(cvtsi2ss, 0xf30f2a, 0, OPC_MODRM, OPT_EA | OPT_REG32, OPT_SSE)
ALT(DEF_ASM_OP2(cvtsi2ss, 0xf30f2a, 0, OPC_MODRM | OPC_48, OPT_REG64, OPT_SSE))
DEF_ASM_OP2(cvtsi2ssl, 0xf30f2a, 0, OPC_MODRM, OPT_EA | OPT_REG32, OPT_SSE)
DEF_ASM_OP2(cvtsi2ssq, 0xf30f2a, 0, OPC_MODRM | OPC_48, OPT_EA | OPT_REG64, OPT_SSE)
DEF_ASM_OP2(cvtsi2sd, 0xf20f2a, 0, OPC_MODRM, OPT_EA | OPT_REG32, OPT_SSE)
ALT(DEF_ASM_OP2(cvtsi2sd, 0xf20f2a, 0, OPC_MODRM | OPC_48, OPT_REG64, OPT_SSE))
DEF_ASM_OP2(cvtsi2sdl, 0xf20f2a, 0, OPC_MODRM, OPT_EA | OPT_REG32, OPT_SSE)
DEF_ASM_OP2(cvtsi2sdq, 0xf20f2a, 0, OPC_MODRM | OPC_48, OPT_EA | OPT_REG64, OPT_SSE)
