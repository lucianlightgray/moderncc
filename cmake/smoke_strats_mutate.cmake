...
if(_high EQUAL 0)
    message(FATAL_ERROR "smoke/strats-known-positive: the run was told to "
                        "expect ${_over} strategies over a table this target "
                        "lights ${MIN_STRATS} of and reported OK. A floor that "
                        "does not read the table it floors renders a subject "
                        "reaching 8 strategies identically to one reaching all "
                        "of them -- which is the state this cell exists to "
                        "refuse, and the state the suite was actually in until "
                        "2026-08-10")
endif()
...
message("smoke/strats-known-positive: ${MIN_STRATS} accepted, ${_over} "
        "refused, and the refusal named the strategy floor")
