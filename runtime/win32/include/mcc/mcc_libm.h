...
int __cdecl __signbitl(long double x) {
	return __signbit(x);
}
...
long double __cdecl fminl(long double x, long double y) {
	return MCCFP_FMIN_EVAL;
}
...
long double __cdecl fmaxl(long double x, long double y) {
	return MCCFP_FMAX_EVAL;
}
...
long long __cdecl llroundf(float x) {
	return round(x);
}
...
long __cdecl lroundl(long double x) {
	return round(x);
}

__CRT_INLINE

long long __cdecl llroundl(long double x) {
	return round(x);
}
...
long double __cdecl nanl(const char *s) {
	return NAN;
}
...
long double __cdecl scalbnl(long double x, int n) {
	return scalbn(x, n);
}

__CRT_INLINE

double __cdecl scalbln(double x, long n) {
	return scalbn(x, n);
}

__CRT_INLINE

float __cdecl scalblnf(float x, long n) {
	return scalbn(x, n);
}

__CRT_INLINE

long double __cdecl scalblnl(long double x, long n) {
	return scalbn(x, n);
}
...
float __cdecl frexpf(float x, int *y) {
	return frexp(x, y);
}

__CRT_INLINE

long double __cdecl frexpl(long double x, int *y) {
	return frexp(x, y);
}
...
long double __cdecl nextafterl(long double x, long double to) {
	return nextafter(x, to);
}

__CRT_INLINE

double __cdecl nexttoward(double x, long double to) {
	return nextafter(x, to);
}

__CRT_INLINE

float __cdecl nexttowardf(float x, long double to) {
	return nextafterf(x, to);
}

__CRT_INLINE

long double __cdecl nexttowardl(long double x, long double to) {
	return nextafter(x, to);
}
...
long double __cdecl modfl(long double x, long double *y) {
	double y1 = *y;
	x = modf(x, &y1);
	*y = y1;
	return x;
...
long double __cdecl log1pl(long double x) {
	return log1p(x);
}
...
long double __cdecl expm1l(long double x) {
	return expm1(x);
}
...
long double __cdecl log2l(long double x) {
	return log(x) * 1.442695040888963407;
}
...
long double __cdecl exp2l(long double x) {
	return exp(x * 0.693147180559945309);
}
...
int __cdecl ilogbl(long double x) {
	return (int)logb(x);
}
