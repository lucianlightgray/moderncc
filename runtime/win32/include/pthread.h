...
static inline int pthread_mutexattr_init(pthread_mutexattr_t *__a) { __a->__type = 0; return 0; }
static inline int pthread_mutexattr_destroy(pthread_mutexattr_t *__a) { (void)__a; return 0; }
static inline int pthread_mutexattr_settype(pthread_mutexattr_t *__a, int __t) { __a->__type = __t; return 0; }
...
static inline int pthread_mutex_unlock(pthread_mutex_t *__m) { ReleaseSRWLockExclusive(__m); return 0; }
...
static inline int pthread_cond_signal(pthread_cond_t *__c) { WakeConditionVariable(__c); return 0; }
static inline int pthread_cond_broadcast(pthread_cond_t *__c) { WakeAllConditionVariable(__c); return 0; }
...
static inline int pthread_key_delete(pthread_key_t __k) { TlsFree(__k); return 0; }
static inline void *pthread_getspecific(pthread_key_t __k) { return TlsGetValue(__k); }
