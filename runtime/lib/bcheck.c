...
#if !defined(__FreeBSD__) && !defined(__FreeBSD_kernel__) && !defined(__DragonFly__) && !defined(__OpenBSD__) && !defined(__APPLE__) && !defined(__NetBSD__)
#include <malloc.h>
#endif
...
#if defined(__FreeBSD__) || defined(__FreeBSD_kernel__) || defined(__DragonFly__) || defined(__OpenBSD__) || defined(__NetBSD__) || defined(__dietlibc__)
...
#define HAVE_TLS_VAR (0)
#endif
#if MCC_CONFIG_MUSL || defined __ANDROID__
#undef HAVE_CTYPE
#endif
#endif
...
void __attribute__((destructor)) __bound_exit(void) {
	...
	if (inited) {
#if !defined(_WIN32) && !defined(__APPLE__) && !MCC_CONFIG_MUSL &&           \
