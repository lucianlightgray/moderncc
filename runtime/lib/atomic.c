...
__asm__(
		"        .global " STR(_(__atomic_load_1)) "\n" TYPE(STR(_(__atomic_load_1))) "" STR(_(__atomic_load_1)) ":\n"
																																																						 "        mov    0x4(%esp),%eax\n"
																																																						 "        movzbl (%eax),%eax\n"
																																																						 "        ret\n" SIZE(STR(_(__atomic_load_1))));

__asm__(
		"        .global " STR(_(__atomic_load_2)) "\n" TYPE(STR(_(__atomic_load_2))) "" STR(_(__atomic_load_2)) ":\n"
																																																						 "        mov    0x4(%esp),%eax\n"
																																																						 "        movzwl (%eax),%eax\n"
																																																						 "        ret\n" SIZE(STR(_(__atomic_load_2))));

__asm__(
		"        .global " STR(_(__atomic_load_4)) "\n" TYPE(STR(_(__atomic_load_4))) "" STR(_(__atomic_load_4)) ":\n"
																																																						 "        mov    0x4(%esp),%eax\n"
																																																						 "        mov    (%eax),%eax\n"
																																																						 "        ret\n" SIZE(STR(_(__atomic_load_4))));

__asm__(
		"        .global " STR(_(__atomic_load_8)) "\n" TYPE(STR(_(__atomic_load_8))) "" STR(_(__atomic_load_8)) ":\n"
																																																						 "        sub    $0xc,%esp\n"
																																																						 "        mov    0x10(%esp),%eax\n"
																																																						 "        fildll (%eax)\n"
																																																						 "        fistpll (%esp)\n"
...
__asm__(
		"        .global " STR(_(__atomic_store_1)) "\n" TYPE(STR(_(__atomic_store_1))) "" STR(_(__atomic_store_1)) ":\n"
																																																								"        mov    0x4(%esp),%edx\n"
																																																								"        mov    0x8(%esp),%eax\n"
																																																								"        xchg   %al,(%edx)\n"
...
__asm__(
		"        .global " STR(_(__atomic_store_2)) "\n" TYPE(STR(_(__atomic_store_2))) "" STR(_(__atomic_store_2)) ":\n"
																																																								"        mov    0x4(%esp),%edx\n"
																																																								"        mov    0x8(%esp),%eax\n"
																																																								"        xchg   %ax,(%edx)\n"
...
__asm__(
		"        .global " STR(_(__atomic_store_4)) "\n" TYPE(STR(_(__atomic_store_4))) "" STR(_(__atomic_store_4)) ":\n"
																																																								"        mov    0x4(%esp),%edx\n"
																																																								"        mov    0x8(%esp),%eax\n"
																																																								"        xchg   %eax,(%edx)\n"
...
__asm__(
		"        .global " STR(_(__atomic_store_8)) "\n" TYPE(STR(_(__atomic_store_8))) "" STR(_(__atomic_store_8)) ":\n"
																																																								"        push   %ebx\n"
																																																								"        sub    $0x8,%esp\n"
																																																								"        mov    0x18(%esp),%ebx\n"
																																																								"        mov    0x14(%esp),%ecx\n"
...
__asm__(
		"        .global " STR(_(__atomic_compare_exchange_1)) "\n" TYPE(STR(_(__atomic_compare_exchange_1))) "" STR(_(__atomic_compare_exchange_1)) ":\n"
																																																																								 "        push   %ebx\n"
																																																																								 "        mov    0xc(%esp),%ecx\n"
																																																																								 "        mov    0x8(%esp),%edx\n"
																																																																								 "        movzbl 0x10(%esp),%ebx\n"
...
__asm__(
		"        .global " STR(_(__atomic_compare_exchange_2)) "\n" TYPE(STR(_(__atomic_compare_exchange_2))) "" STR(_(__atomic_compare_exchange_2)) ":\n"
																																																																								 "        push   %ebx\n"
																																																																								 "        mov    0xc(%esp),%ecx\n"
																																																																								 "        mov    0x8(%esp),%edx\n"
																																																																								 "        movzwl 0x10(%esp),%ebx\n"
...
__asm__(
		"        .global " STR(_(__atomic_test_and_set_1)) "\n" TYPE(STR(_(__atomic_test_and_set_1))) "" STR(_(__atomic_test_and_set_1)) ":\n"
																																																																		 "        mov    0x4(%esp),%edx\n"
																																																																		 "        mov    $0x1,%eax\n"
																																																																		 "        xchg   %al,(%edx)\n"
...
__asm__(
		"        .global " STR(_(__atomic_test_and_set_2)) "\n" TYPE(STR(_(__atomic_test_and_set_2))) "" STR(_(__atomic_test_and_set_2)) ":\n"
																																																																		 "        mov    0x4(%esp),%edx\n"
																																																																		 "        mov    $0x1,%eax\n"
																																																																		 "        xchg   %al,(%edx)\n"
...
__asm__(
		"        .global " STR(_(__atomic_test_and_set_4)) "\n" TYPE(STR(_(__atomic_test_and_set_4))) "" STR(_(__atomic_test_and_set_4)) ":\n"
																																																																		 "        mov    0x4(%esp),%edx\n"
																																																																		 "        mov    $0x1,%eax\n"
																																																																		 "        xchg   %al,(%edx)\n"
...
__asm__(
		"        .global " STR(_(__atomic_test_and_set_8)) "\n" TYPE(STR(_(__atomic_test_and_set_8))) "" STR(_(__atomic_test_and_set_8)) ":\n"
																																																																		 "        mov    0x4(%esp),%edx\n"
																																																																		 "        mov    $0x1,%eax\n"
																																																																		 "        xchg   %al,(%edx)\n"
...
__asm__(
		"        .global " STR(_(atomic_thread_fence)) "\n" TYPE(STR(_(atomic_thread_fence))) "" STR(_(atomic_thread_fence)) ":\n"
																																																												 "        lock orl $0x0,(%esp)\n"
																																																												 "        ret\n" SIZE(STR(_(atomic_thread_fence))));

__asm__(
		"        .global " STR(_(atomic_signal_fence)) "\n" TYPE(STR(_(atomic_signal_fence))) "" STR(_(atomic_signal_fence)) ":\n"
																																																												 "        ret\n" SIZE(STR(_(atomic_signal_fence))));

__asm__(
		"        .global " STR(_(atomic_flag_test_and_set)) "\n" TYPE(STR(_(atomic_flag_test_and_set))) "" STR(_(atomic_flag_test_and_set)) ":\n"
																																																																				"        mov    0x4(%esp),%edx\n"
																																																																				"        mov    $0x1,%eax\n"
																																																																				"        xchg   %al,(%edx)\n"
...
__asm__(
		"        .global " STR(_(atomic_flag_test_and_set_explicit)) "\n" TYPE(STR(_(atomic_flag_test_and_set_explicit))) "" STR(_(atomic_flag_test_and_set_explicit)) ":\n"
																																																																																	 "        mov    0x4(%esp),%edx\n"
																																																																																	 "        mov    $0x1,%eax\n"
																																																																																	 "        xchg   %al,(%edx)\n"
...
__asm__(
		"        .global " STR(_(atomic_flag_clear)) "\n" TYPE(STR(_(atomic_flag_clear))) "" STR(_(atomic_flag_clear)) ":\n"
																																																									 "        mov    0x4(%esp),%edx\n"
																																																									 "        xor    %eax,%eax\n"
																																																									 "        xchg   %al,(%edx)\n"
...
__asm__(
		"        .global " STR(_(atomic_flag_clear_explicit)) "\n" TYPE(STR(_(atomic_flag_clear_explicit))) "" STR(_(atomic_flag_clear_explicit)) ":\n"
																																																																							"        mov    0x4(%esp),%edx\n"
																																																																							"        xor    %eax,%eax\n"
																																																																							"        xchg   %al,(%edx)\n"
