...
"        movzbl (%eax),%eax\n"
"        ret\n"
"	.size   " STR(_(__atomic_load_1)) ", .-" STR(_(__atomic_load_1)) "\n"
);
...
"        movzwl (%eax),%eax\n"
"        ret\n"
"	.size   " STR(_(__atomic_load_2)) ", .-" STR(_(__atomic_load_2)) "\n"
);
...
"        mov    (%eax),%eax\n"
"        ret\n"
"	.size   " STR(_(__atomic_load_4)) ", .-" STR(_(__atomic_load_4)) "\n"
);
...
"        add    $0xc,%esp\n"
"        ret\n"
"	.size   " STR(_(__atomic_load_8)) ", .-" STR(_(__atomic_load_8)) "\n"
);
...
"        xchg   %al,(%edx)\n"
"        ret\n"
"	.size   " STR(_(__atomic_store_1)) ", .-" STR(_(__atomic_store_1)) "\n"
);
...
"        xchg   %ax,(%edx)\n"
"        ret\n"
"	.size   " STR(_(__atomic_store_2)) ", .-" STR(_(__atomic_store_2)) "\n"
);
...
"        xchg   %eax,(%edx)\n"
"        ret\n"
"	.size   " STR(_(__atomic_store_4)) ", .-" STR(_(__atomic_store_4)) "\n"
);
...
"        pop    %ebx\n"
"        ret\n"
"	.size   " STR(_(__atomic_store_8)) ", .-" STR(_(__atomic_store_8)) "\n"
);
...
"        pop    %ebx\n"
"        ret\n"
"	.size   " STR(_(__atomic_compare_exchange_1)) ", .-" STR(_(__atomic_compare_exchange_1)) "\n"
);
...
"        pop    %ebx\n"
"        ret\n"
"	.size   " STR(_(__atomic_compare_exchange_2)) ", .-" STR(_(__atomic_compare_exchange_2)) "\n"
);
...
"        pop    %ebx\n"
"        ret\n"
"	.size   " STR(_(__atomic_compare_exchange_4)) ", .-" STR(_(__atomic_compare_exchange_4)) "\n"
);
...
"        pop    %edi\n"
"        ret\n"
"	.size   " STR(_(__atomic_compare_exchange_8)) ", .-" STR(_(__atomic_compare_exchange_8)) "\n"
);
...
"        xchg   %al,(%edx)\n"
"        ret\n"
"	.size   " STR(_(__atomic_test_and_set_1)) ", .-" STR(_(__atomic_test_and_set_1)) "\n"
);
...
"        xchg   %al,(%edx)\n"
"        ret\n"
"	.size   " STR(_(__atomic_test_and_set_2)) ", .-" STR(_(__atomic_test_and_set_2)) "\n"
);
...
"        xchg   %al,(%edx)\n"
"        ret\n"
"	.size   " STR(_(__atomic_test_and_set_4)) ", .-" STR(_(__atomic_test_and_set_4)) "\n"
);
...
"        xchg   %al,(%edx)\n"
"        ret\n"
"	.size   " STR(_(__atomic_test_and_set_8)) ", .-" STR(_(__atomic_test_and_set_8)) "\n"
);
...
"        lock orl $0x0,(%esp)\n"
"        ret\n"
"	.size   " STR(_(atomic_thread_fence)) ", .-" STR(_(atomic_thread_fence)) "\n"
);
...
"        ret\n"
"	.size   " STR(_(atomic_signal_fence)) ", .-" STR(_(atomic_signal_fence)) "\n"
);
...
"        xchg   %al,(%edx)\n"
"        ret\n"
"	.size   " STR(_(atomic_flag_test_and_set)) ", .-" STR(_(atomic_flag_test_and_set)) "\n"
);
...
"        xchg   %al,(%edx)\n"
"        ret\n"
"	.size   " STR(_(atomic_flag_test_and_set_explicit)) ", .-" STR(_(atomic_flag_test_and_set_explicit)) "\n"
);
...
"        xchg   %al,(%edx)\n"
"        ret\n"
"	.size   " STR(_(atomic_flag_clear)) ", .-" STR(_(atomic_flag_clear)) "\n"
);
...
"        xchg   %al,(%edx)\n"
"        ret\n"
"	.size   " STR(_(atomic_flag_clear_explicit)) ", .-" STR(_(atomic_flag_clear_explicit)) "\n"
);
