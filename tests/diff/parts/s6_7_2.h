/* C9911 §6.7.2.1-§6.7.2.4 Struct/union/enum/atomic specifiers (s6_7_2) — main-free test unit.
   No #includes: the includer provides the environment (full_language.c
   via mcclib.h; parts/run_s6_7_2.c via <std_env.h>). Compiled 3-way
...
enum s6_7_2_e { s6_7_2_A, s6_7_2_B, s6_7_2_C = 10, s6_7_2_D, s6_7_2_E = 10, };
...
void s6_7_2_specifiers(void)
{
    ...
    f->n = 3;
    for (int i = 0; i < f->n; i++) f->a[i] = i * 10;
    printf("fam: %d %d %d\n", f->a[0], f->a[1], f->a[2]);
    free(f);

    struct s6_7_2_boolbf bb;
    bb.b = 1; printf("boolbf1: %d\n", bb.b == 1);
    bb.b = 2; printf("boolbf2: %d\n", bb.b == 1);
    bb.b = 0; printf("boolbf0: %d\n", bb.b == 0);
    ...
    union s6_7_2_u { char c; int i; double d; } u;
    printf("union-size: %d\n", (int)(sizeof(u) >= sizeof(double)));
    u.d = 0; u.i = 99;
    printf("union-store: %d\n", u.i);

    struct s6_7_2_pack { unsigned a : 5, b : 5; } pk;
    pk.a = 31; pk.b = 17;
