/* C9911 <stddef.h> & <stdint.h> (s_stddef) — main-free test unit.
   No #includes: the includer provides the environment (full_language.c
   via mcclib.h; parts/run_s_stddef.c via <std_env.h>). Compiled 3-way
   (gcc/clang/mcc) as a unit by the parts-suite, and aggregated into
   full_language.c. */
/* <stddef.h> & <stdint.h> runtime coverage (C9911 §7.17/§7.18 [§7.19/§7.20]).
   <stddef.h> arrives via mcclib.h; pull in <stdint.h> for the integer types.
   (This #include re-defines the file-local INT64_MIN from an identical value,
   producing only a -w-suppressed redefinition warning.) */

struct s_stddef_st { char c; int i; double d; char arr[8]; };

/* §7.17p3 [§7.19p3] offsetof(type, member) equals the byte offset from the
   start of the object, including array-subscript member designators. */
...
{
    /* §7.18.1.1 [§7.20.1.1] exact-width types have width exactly N. */
    ...
    /* §7.18.2.1 [§7.20.2.1] exact-width limits equal the mandated exact values. */
    ...
    /* §7.18.4 [§7.20.4] INTn_C/UINTn_C/INTMAX_C give the right value and the
       unsigned macros yield a wide unsigned type (0-1 wraps to a huge value). */
    ...
    /* §7.18.2/§7.18.3 [§7.20.2/§7.20.3] required minimum magnitudes for the
       implementation-defined limit macros (printed as target-agnostic bounds). */
