...
int main(void)
{
...

    {
        ...
        t = strsep(&sp, ",");  if (!t || t[0] != 0)                          return 7;
        t = strsep(&sp, ",");  if (!t || t[0] != 'b' || t[1] != 0)           return 8;
        t = strsep(&sp, ",");  if (t != NULL)                                return 9;
    }
...

    {
        ...
        if (memmem(hay, sizeof(hay) - 1, "", 0) != NULL) return 12;
        if (memmem(hay, 0, "x", 1) != NULL)              return 18;
    }
...

    {
        ...
        if (!none || *none != 0 || (none - s) != 12)     return 14;
    }
...

    {
        ...
        if (strnstr(s, "gamma", 8) != NULL)  return 16;
        if (strnstr(s, "", 16) != s)         return 17;
    }
