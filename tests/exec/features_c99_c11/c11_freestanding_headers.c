...
int main(void)
{
    ...
    if (INT_MAX != 2147483647 || INT_MIN != (-2147483647 - 1)) ok = 0;
    ...
    if (INT32_MAX != 2147483647 || (uint32_t)UINT32_MAX != 4294967295U) ok = 0;
...
# endif
    ...
    if (!(0 or 1)) ok = 0;
    if ((compl 0) != ~0) ok = 0;
    if ((5 bitand 3) != (5 & 3)) ok = 0;
    if ((5 bitor 2) != (5 | 2)) ok = 0;
    if ((5 xor 1) != (5 ^ 1)) ok = 0;
    if (not 0 != !0) ok = 0;
    if ((1 not_eq 2) != (1 != 2)) ok = 0;

#ifndef FLT_EVAL_METHOD
    ok = 0;
#endif
    if (FLT_HAS_SUBNORM != 1 || DBL_HAS_SUBNORM != 1 || LDBL_HAS_SUBNORM != 1) ok = 0;
    if (FLT_DECIMAL_DIG != 9) ok = 0;
    if (DBL_DECIMAL_DIG != 17) ok = 0;
    if (LDBL_DECIMAL_DIG < 17) ok = 0;
    if (!(FLT_TRUE_MIN > 0.0f && FLT_TRUE_MIN < FLT_MIN)) ok = 0;
    if (!(DBL_TRUE_MIN > 0.0 && DBL_TRUE_MIN < DBL_MIN)) ok = 0;
    if (!(LDBL_TRUE_MIN > 0.0L && LDBL_TRUE_MIN < LDBL_MIN)) ok = 0;
