...
int main(void) {
	...
	int ok = __builtin_clz(v) == 24 && __builtin_ctz(v) == 4 && __builtin_popcount(v) == 4 && __builtin_ffs(s) == 5 && __builtin_parity(v) == 0 && __builtin_clrsb(s) == 27 && __builtin_clzll(L) == 48 && __builtin_ctzll(L) == 15 && __builtin_popcountll(L) == 1;
