...
static const gate_t GATES[] = {
	...
	{"CONVERT_GV", "MCC_AST_CONVERT_GV=1"},
	{"CALL_NORETURN", "MCC_AST_CALL_NORETURN=1"},
	...
	{"RECORDER8",
	 "MCC_AST_STOREVAL_CONSTL=1 MCC_AST_CONVERT_GV=1 MCC_AST_CALL_NORETURN=1 "
	 "MCC_AST_STOREVAL_CALLSTORE=1 MCC_AST_FNEG=1 MCC_AST_CMP_MAT=1 "
	 "MCC_AST_CHAINSTORE_LIVE=1 MCC_AST_CHAINSTORE_MEMBER=1"},
};
