...
static S2i  f1(S2i s) { s.a += 1; s.b += 2; return s; }
...
int main(void)
{
    S2i a; memset(&a, 0, sizeof a); a.a = 10; a.b = 20;
    a = f1(f1(a));
    printf("S2i %d %d\n", a.a, a.b); dump("S2i", &a, sizeof a);

    Sid b; memset(&b, 0, sizeof b); b.a = 0x1234; b.d = 3.5;
    b = f2(b);
    printf("Sid %d %g\n", b.a, b.d); dump("Sid", &b, sizeof b);

    S2d c; memset(&c, 0, sizeof c); c.x = 1.5; c.y = 2.5;
    c = f3(f3(c));
    printf("S2d %g %g\n", c.x, c.y); dump("S2d", &c, sizeof c);

    S3l d; memset(&d, 0, sizeof d); d.a = 1; d.b = 2; d.c = 3;
    d = f4(d);
    printf("S3l %ld %ld %ld\n", d.a, d.b, d.c); dump("S3l", &d, sizeof d);

    S4f e; memset(&e, 0, sizeof e); e.a = 1; e.b = 2; e.c = 3; e.d = 4;
    e = f5(f5(e));
    printf("S4f %g %g %g %g\n", e.a, e.b, e.c, e.d); dump("S4f", &e, sizeof e);

    Snest f; memset(&f, 0, sizeof f);
    f.lo.a = 1; f.lo.b = 1; f.hi.a = 2; f.hi.b = 2;
    f = f6(f);
