...
| win-x64   | Windows  | x64   | 50000–69999 | 50001   | 2026-08-14T21:25Z |
...
- [ ] T-win-50000 [X] win-x64 — CodeView type residue: unions/enums/arrays + typed variable symbols
      OWNER: win-x64 | STATE: IN_PROGRESS | SHA: f8d5ae82 | TS: 2026-08-14T21:25Z
      REF: DETAILS.md#t-win-50000-codeview-type-residue | DEPS: — | NOTE: type-record set + typed GLOBAL vars (S_GDATA32/S_LDATA32) done f8d5ae82; residue = local vars (S_LOCAL/S_DEFRANGE, frame-rel) + dedup
