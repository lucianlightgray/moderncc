...
- i386: ASan native-shadow, stack-protector, TLS GD/LDM, 64-bit div-magic helper, JIT stub tail, Tier-4 replay-inline.
- arm (armv7): raise from Tier-2 — self-host, ASan native-shadow, stack-protector, JIT stub tail, replay-inline; signed-mul overflow check.
