...
- [ ] T-lin-10387 [P] Re-bank the per-platform lowerable floors for b1f912b5's benign source addition (rir-coverage self/wide nodes_pct)
  ...
  - [ ] T-lin-10387/mac [P] macho lowerable floors — mac-arm64
        OWNER: mac-arm64 | STATE: CLAIMED | SHA: 496271d4 | TS: 2026-08-15T19:48Z
        REF: DETAILS.md#t-lin-10384-macho-red-resolved-source-dilution-not-r-arity-the-census-never-calls-the-ladder | DEPS: — | NOTE: the mac half of my own §8 red. Will independently confirm on-box that the moved body is ast_eval_ladder_scan (the +25-line grown banked body), then rir-coverage.py --update-bank-low, verify rir-coverage green, inspect the bank diff shows only the expected macho lowerable floor move, commit. Greens my T-lin-10385 §8 too
