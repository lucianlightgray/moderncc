...
static void suite_template(void) {
	...
	cst_binding_select(ib_a, cst_first_child(cst_store_get(store, tin), cst_root(cst_store_get(store, tin))), 0);
	...
	cst_binding_select(ib_b, cst_first_child(cst_store_get(store, tin), cst_root(cst_store_get(store, tin))), 1);
	...
	cst_binding_select(ib_c, cst_first_child(cst_store_get(store, tin), cst_root(cst_store_get(store, tin))), 0);
